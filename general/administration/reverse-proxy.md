...
Three popular options for reverse proxy systems are [Apache](https://httpd.apache.org/), [Haproxy](https://www.haproxy.com/), [Caddy](https://caddyserver.com/), and [Nginx](https://www.nginx.com/).
...
```
# Jellyfin
DOMAIN_NAME/jellyfin/ {  # Using DOMAIN_NAME only, or sub.DOMAIN_NAME would also work
...
If using a subpath, note that `DOMAIN_NAME/jellyfin` will not resolve, the ending slash is needed. To get around this, you can add the following to your `Caddyfile`:
